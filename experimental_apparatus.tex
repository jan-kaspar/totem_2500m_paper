...
\caption{%
Schematic view of the RP units (black squares) used for the presented measurement with two proton tracks from an elastic event (lines with arrows). The numbers at the bottom indicate the distance from the interaction point.
}
\label{fig:rpsketch}
\end{center}
\end{figure*}
