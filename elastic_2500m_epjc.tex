...
\title{First determination of the $\mathbf{\rho}$ parameter at $\mathbf{\sqrt s = 13}$ TeV -- probing the existence of a colourless crossing-odd three-gluon compound state}
