...
\title{First determination of the $\mathbf{\rho}$ parameter at $\mathbf{\sqrt s = 13}$ TeV -- probing the existence of a colourless C-odd three-gluon compound state}

\titlerunning{First determination of $\rho$ at $\sqrt s = 13$ TeV -- probing a colourless C-odd 3-gluon compound state}
