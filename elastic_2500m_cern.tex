...
\title{Determination of the $\mathbf{\rho}$ parameter at $\mathbf{\sqrt s = 13}$\, TeV and its implications on the existence of the Odderon}

\ShortTitle{Determination of $\rho$ at $\sqrt s = 13\un{TeV}$ and its implications on the existence of the Odderon}

% TODO
\Collaboration{The TOTEM Collaboration \TODO{update}}
