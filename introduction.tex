...
The high precision obtained in the measurement of $pp$ elastic scattering has already shown that the differential cross section is best described by a non exponential function~\cite{8tev-90m}[TOTEM non-ex] as postulated already long time ago\cite{Lukaszuk:1973nt,RevModPhys.57.563}[?Nicolescu,Block and Cahn...].
